...
const AuthScreen = () => {
    ...
    return (
        <div className="hero-bg relative">
            ...
            {/* Hero Section */}
            <div className="flex flex-col justify-center text-center py-40 text-white max-w-6xl mx-auto">
                ...
                <form className="flex flex-col md:flex-row gap-4 w-1/2 mx-auto " onSubmit={handleFormSubmit }>
    <input
        type="email"
    ...
    <button
        type="submit"
        className="bg-red-600 text-xl lg:text-2xl px-4 lg:px-6 py-2 rounded flex justify-center items-center"
    >
        Get Started
...
<h2 className="text-4xl md:text-5xl font-extrabold mb-4">
                ...
                <p className="text-lg md:text-xl">Watch on smart TVs ,Playstation, Chromecast,
...
<h2 className="text-4xl md:text-5xl font-extrabold mb-4">
                ...
                <p className="text-lg md:text-xl">Stream unlimited movies and TV shows from your
                    phone,laptop,tablet and TV.
                </p>
...
muted
loop
><source src='video-devices.m4v' type="video/mp4"/></video>
</div>
...
<div className="py-10 bg-black text-white">
  <div className="flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
    {/* Left Section */}
    <div className="flex-1 relative">
      <img src="/kids.png" alt="Enjoy your tv" className="mt-4 w-full max-w-md mx-auto md:mx-0" />
    </div>
    {/* Right Section */}
    <div className="flex-1 text-center md:text-left">
